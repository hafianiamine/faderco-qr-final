"use client"
import { Users, BarChart3, Building2, LogOut, LayoutDashboard, Settings, Clock, QrCode, Shield, Package } from "lucide-react"
...
interface CircularGlassMenuProps {
  userEmail?: string
  userRole?: string
...
export function CircularGlassMenu({ userEmail, userRole, onSectionChange, currentSection }: CircularGlassMenuProps) {
